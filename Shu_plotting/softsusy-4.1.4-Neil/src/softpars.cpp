...
void MssmSoftPars::FGMCaseShu(const MssmSusy & xx, double LAMBDA, 
...
a8= f * sqr(lambda) * (0);
  ...
  setTrilinearElement(EA, 3, 3, -lambda * epse * 3.771236166 * ytau * ytau2);
...
void MssmSoftPars::FGMCaseShuAlt(const MssmSusy & xx, double LAMBDA, 
			       double mMess, double beta2, double beta3, double cgrav) {
...
void MssmSoftPars::FGMCaseShuLarge(const MssmSusy & xx, double LAMBDA, 
			       double mMess,  double cgrav) {
...
void MssmSoftPars::FGMCaseShuLargeNonRN(const MssmSusy & xx, double LAMBDA, 
  ...
  //Ql
a4= f* sqr(lambda)*((-2*pow(betaeps,2)*(8*g12 + 36*g22 + 64*g32 + 9*(pow(yb,2) + pow(yt,2)) + 3*pow(ytau,2)))/9.);
a8= f * sqr(lambda) *((-2*(g12*(7*pow(yb,2) + 13*pow(yt,2)) + 5*(9*g22*(pow(yb,2) + pow(yt,2)) + 16*g32*(pow(yb,2) + pow(yt,2)) + 
          pow(betaeps,2)*(4*pow(yb,2) + 3*pow(yt,2)) - 
          6*(9*pow(yb,4) + 9*pow(yt,4) + 2*pow(yb,2)*(pow(yt,2) + pow(ytau,2))))))/15.);
  ...
  //Ur
a0= f * sqr(lambda) *((-2*pow(betaeps,2)*(13*g12 + 45*g22 + 80*g32))/15.);
a4= f * sqr(lambda) *((-2*pow(betaeps,2)*(13*g12 + 45*g22 + 80*g32 + 90*pow(yt,2)))/45.);
a8=f * sqr(lambda) *((-4*pow(yt,2)*(13*g12 + 5*(3*pow(betaeps,2) + 9*g22 + 16*g32 - 6*(pow(yb,2) + 9*pow(yt,2)))))/15.);
...
a0=f *sqr(lambda) * ((-2*pow(betaeps,2)*(7*g12 + 45*g22 + 80*g32 - 30*pow(ytau,2)))/15.);
a4=f *sqr(lambda) * ((-2*pow(betaeps,2)*(7*g12 + 45*g22 + 80*g32 + 90*pow(yb,2)))/45.);
a8=f *sqr(lambda) * ((4*pow(yb,2)*(-7*g12 - 45*g22 - 80*g32 + 30*(9*pow(yb,2) +pow(yt,2) + 3*pow(ytau,2))))/15.);  
  setSoftMassElement(mDr,1,1, mdrsq + a0);
  setSoftMassElement(mDr,1,2, a1);
  setSoftMassElement(mDr,1,3, a2);
  setSoftMassElement(mDr,2,1, a3);
  ...
  //Ll
a4=f * sqr(lambda)*((-2*pow(betaeps,2)*(18*g12 + 5*(6*g22 + 3*pow(yb,2) + pow(ytau,2))))/15.);
a8=f * sqr(lambda) *((2*pow(ytau,2)*(-27*g12 - 5*(4*pow(betaeps,2) + 9*g22 - 36*pow(yb,2) - 30*pow(ytau,2))))/15.);
  ...
  //Er
a0=f * sqr(lambda) *((-6*pow(betaeps,2)*(3*g12 + 5*g22))/5.);
a4=f * sqr(lambda) *((-2*pow(betaeps,2)*(9*g12 + 5*(3*g22 + 6*pow(yb,2) + 2*pow(ytau,2))))/15.);
a8=f * sqr(lambda) *((4*pow(ytau,2)*(-27*g12 - 5*(4*pow(betaeps,2) + 9*g22 - 36*pow(yb,2) - 30*pow(ytau,2))))/15.);
  ...
  //higgs masses
  double deltaHu = - f * sqr(lambda) * 6*pow(yt,2)*(pow(yb,2) + 3*pow(yt,2));
  
  double deltaHd = - f * sqr(lambda) * 6*(3*pow(yb,4) + pow(yb,2)*pow(yt,2) + 3*pow(ytau,4));
