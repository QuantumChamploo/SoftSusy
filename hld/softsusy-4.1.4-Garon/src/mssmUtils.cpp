...
namespace softsusy {
  ...
  void FGMCaseB2bcs(MssmSoftsusy & m, const DoubleVector & inputParameters) {
    ...
    void FGMCaseB1LargeNonRNbcs(MssmSoftsusy & m, const DoubleVector & inputParameters) {
    m.FGMCaseB1LargeNonRN(m.displayMssmSusy(), inputParameters(1), inputParameters(2), inputParameters(3), inputParameters(4));
