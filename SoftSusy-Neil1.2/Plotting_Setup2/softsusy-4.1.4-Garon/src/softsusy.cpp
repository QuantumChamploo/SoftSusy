...
void MssmSoftsusy::minparSLHA(ostream & out, const char model [], 
  ...
  else if (!strcmp(model,"FGMCaseShu")){
    out << "     1   "; printRow(out, pars.display(1)); out << "   # lambdas" << endl;
    out << "     2   "; printRow(out, pars.display(2)); out << "   # M_mess" << endl;
    out << "     3   "; printRow(out, pars.display(3)); out << "   # epsu" << endl;
    out << "     4   "; printRow(out, pars.display(4)); out << "   # epsd" << endl;
    out << "     5   "; printRow(out, pars.display(5)); out << "   # epse" << endl;
    out << "     6   "; printRow(out, pars.display(6)); out << "   # cgrav" << endl;
  }
  else if (!strcmp(model,"FGMCaseShuLarge")){
    out << "     1   "; printRow(out, pars.display(1)); out << "   # lambda" << endl;
    out << "     2   "; printRow(out, pars.display(2)); out << "   # M_mess" << endl;
    out << "     6   "; printRow(out, pars.display(4)); out << "   # cgrav" << endl;
  }
  else if (!strcmp(model,"FGMCaseShuLargeNonRN")){
    out << "     1   "; printRow(out, pars.display(1)); out << "   # lambda" << endl;
    out << "     2   "; printRow(out, pars.display(2)); out << "   # M_mess" << endl;
