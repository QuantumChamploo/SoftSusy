...
namespace softsusy {
  ...
  public:
    ...
    void FGMCaseB0(const MssmSusy & xx, double LAMBDA, 
		     double mMess, double cgrav); 
	void FGMCaseShu(const MssmSusy & xx, double LAMBDA, 
		     double mMess,  double epsu, double epsd, double epse, double cgrav);
	void FGMCaseShuAlt(const MssmSusy & xx, double LAMBDA, 
		     double mMess, double beta2, double beta3, double cgrav);
	void FGMCaseB2(const MssmSusy & xx, double LAMBDA, 
		     double mMess, double beta2, double beta3, double cgrav); 
	void FGMCaseShuLarge(const MssmSusy & xx, double LAMBDA, 
		     double mMess, double cgrav);
    void FGMCaseShuLargeNonRN(const MssmSusy & xx, double LAMBDA, 
